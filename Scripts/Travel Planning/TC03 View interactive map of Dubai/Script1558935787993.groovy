...
WebUI.mouseOver(getElement('css', '#plhcontent_1_panelContainer > div > div > a:nth-child(4)'))
Thread.sleep(500);

String Colorcode1  = driver.findElement(By.xpath('//*[@id="plhcontent_1_panelContainer"]/div/div/a[4]')).getCssValue("background-color");
