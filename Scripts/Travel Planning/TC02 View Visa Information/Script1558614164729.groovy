...
selenium.click("xpath=//*[@id='ctl15_ctl02_rptSuperCategories_hlCategory_3']")
WebUI.waitForPageLoad(20000)

String Colorcode  = driver.findElement(By.xpath('//*[@id="ctl17_ctl02_rptSuperCategories_hlCategory_3"]')).getCssValue("color");
...
WebUI.mouseOver(getElement('css', '#plhcontent_1_panelContainer > div > div > a:nth-child(1)'))
Thread.sleep(500);

String Colorcode1  = driver.findElement(By.xpath('//*[@id="plhcontent_1_panelContainer"]/div/div/a[1]')).getCssValue("background-color");
