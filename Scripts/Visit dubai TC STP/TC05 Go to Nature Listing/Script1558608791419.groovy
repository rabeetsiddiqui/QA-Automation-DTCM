...
String expandableLink = '//*[@id="ctl15_ctl02_rptSuperCategories_rptCategories_2_rptSubCategories_3_hlItem_0"]';

WebUI.mouseOver(getElement("css","#ctl15_ctl02_rptSuperCategories_hlCategory_2"))

WebUI.click(getElement('xpath', '//*[@id="ctl15_ctl02_rptSuperCategories_rptCategories_2_hlItem_3"]'))
