...
String expandableLink = '.homepage_section .mobile_nav .main-nav .nav-section > li:nth-child(4) > ul > li:nth-child(9) > ul > li:nth-child(3) > a';

WebUI.mouseOver(getElement("css",".homepage_section .mobile_nav .main-nav .nav-section > li:nth-child(4)"))

WebUI.click(getElement('css', '.homepage_section .mobile_nav .main-nav .nav-section > li:nth-child(4) > ul > li:nth-child(9)'))
