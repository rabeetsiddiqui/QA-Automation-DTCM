...
WebUI.scrollToElement(getElement('css', '#divHomeWrap > div > div.content_wrap.hotel-location-detail.general-content-wrap > div.rightColumn.content_cell.tablet_break.trip-planner-right-block > div:nth-child(7) > div > ul > li:nth-child(1)'), 15)

WebUI.click(getElement('css', '#overview .content_section > div:nth-child(3) .info_block_items > span > a'))

String Text =WebUI.getText(getElement('css', '#overview .content_section > div:nth-child(3) .info_block_items > span > a'))
println (Text)
