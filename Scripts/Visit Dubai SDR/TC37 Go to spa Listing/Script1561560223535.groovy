...
WebUI.click(getElement('css', '.main-nav .nav-section .high-level.hover >ul >li:nth-child(6)'))
WebUI.click(getElement('css', '.main-nav .nav-section .high-level.hover >ul >li:nth-child(6) > ul >li:nth-child(3)'))
