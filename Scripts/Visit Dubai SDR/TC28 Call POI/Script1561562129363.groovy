...
WebUI.click(getElement('css', '#overview .content_section > div:nth-child(1) .info_block_items > span > a'))

String Text =WebUI.getText(getElement('css', '#overview .content_section > div:nth-child(1) .info_block_items > span > a'))
println (Text)
