...
WebUI.click(getElement('css', '.new-hero-wrapper.no-tiles .content_wrap .sub-breadcrumb > ul > li:nth-child(3)'))
Thread.sleep(1000)

String NewUrl = WebUI.getUrl();
println (NewUrl)

WebUI.scrollToElement(getElement('css', '#Articles_categoryDataRoot > li:nth-child(8) > div > a > h4'), 15)
WebUI.click(getElement('css', '#Articles_container > div.cta_loadmore.for_web > a'))

Thread.sleep(1000)

WebUI.verifyElementPresent(getElement('css', '#Articles_categoryDataRoot > li:nth-child(14)'), 10)
