...
//Click on Article Detail
WebUI.scrollToElement(getElement('css', '#Articles_categoryDataRoot > li:nth-child(7) > div > a > h4'),15)
WebUI.mouseOver(getElement('css', '#Articles_categoryDataRoot > li:nth-child(7) > div > a > h4'))
Thread.sleep(1500)
WebUI.click(getElement('css', '#Articles_categoryDataRoot > li:nth-child(7) > div > a > h4'))

WebUI.scrollToElement(getElement('css', '.cf .short-related-deals.short-nearby-deals .trip_item > li:nth-child(1) .trip_detail'),15)
WebUI.click(getElement('css', '.cf .short-related-deals.short-nearby-deals .trip_item > li:nth-child(3) .trip_detail > a'))
