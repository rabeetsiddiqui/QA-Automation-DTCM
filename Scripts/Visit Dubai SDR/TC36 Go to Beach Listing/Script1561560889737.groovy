...
WebUI.click(getElement('css', '.main-nav .nav-section .high-level.hover >ul >li:nth-child(5)'))
WebUI.click(getElement('css', '.main-nav .nav-section .high-level.hover >ul >li:nth-child(5) > ul >li:nth-child(3)'))
