...
WebUI.scrollToElement(getElement('css', '#divHomeWrap > div > div.content_wrap.hotel-location-detail.general-content-wrap > div.rightColumn.content_cell.tablet_break.trip-planner-right-block > div:nth-child(7) > div > ul > li:nth-child(3)'), 15)
Thread.sleep(1000)
WebUI.verifyElementVisible(getElement('css', '#divHomeWrap > div > div.content_wrap.hotel-location-detail.general-content-wrap > div.rightColumn.content_cell.tablet_break.trip-planner-right-block > div:nth-child(8) .related-deals-headline'))
Thread.sleep(1000)
WebUI.mouseOver(getElement('css', '#divHomeWrap > div > div.content_wrap.hotel-location-detail.general-content-wrap > div.rightColumn.content_cell.tablet_break.trip-planner-right-block > div:nth-child(8) > div > ul > li:nth-child(1)'))
