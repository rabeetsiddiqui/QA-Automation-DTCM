...
String Afterclick = WebUI.getCSSValue(getElement('css', '#tabMenu > li.ratings.active_tab'), 'background-color')
println (Afterclick)
...
WebUI.focus(getElement('css', '#ratings > div > div > ul:nth-child(1) > li.second'))
WebUI.scrollToElement(getElement('css', '#ratings > div > div > ul:nth-child(1) > li.second'), 10)

String VerifyContent = WebUI.verifyElementPresent(getElement('css', '#plhcontent_0_plhgeneralcontent_0_AttractionsTAReviews_hlWriteAReview'), 0)
println (VerifyContent)
