...
Thread.sleep(500)
WebUI.mouseOver(getElement('css', '#divHomeWrap > div > div.dubai.itineraries.font.itinerary-detail.new-itinerary-detail > div.header > div.panels.itineraries-pages > div > div > div.desc > div.msg.itineraries-detail > a:nth-child(5)'))
Thread.sleep(500)
Default = WebUI.getUrl()

WebUI.click(getElement('css', '#divHomeWrap > div > div.dubai.itineraries.font.itinerary-detail.new-itinerary-detail > div.header > div.panels.itineraries-pages > div > div > div.desc > div.msg.itineraries-detail > a:nth-child(5)'))
Thread.sleep(500)
New = WebUI.getUrl()

if(New.contains("/en/trip-planner#/trip-planner" )== true)
{
	println ("Passed")
}
else(New.contains("/en/trip-planner#/trip-planner" )==  false).call(
{
	println ("Failed")
})
