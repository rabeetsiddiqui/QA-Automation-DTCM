...
import com.thoughtworks.selenium.Wait as Wait
...
String BackgroundColorRed= 'rgba(242, 18, 44, 1)'
...
//WebUI.scrollToElement('xpath', '//*[@id=\'plhcontent_0_Paging_hlNext\']', 2)
...
WebUI.click(getElement('xpath', '//*[@id=\'plhcontent_0_Paging_hlNext\']')) 

JavascriptExecutor js2 = (JavascriptExecutor) driver;
js2.executeScript("window.scrollTo(0, document.body.scrollHeight)");

String Colorcode = driver.findElement(By.xpath('//*[@id="plhcontent_0_Paging_rptrPages_hlPage_1"]')).getCssValue('color')
