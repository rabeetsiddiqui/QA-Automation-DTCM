...
WebUI.scrollToElement(getElement('css', '.sort-in-days-container'), 15)

Thread.sleep(1000)


WebUI.dragAndDropByOffset(getElement('css', '.tp_day-container:nth-child(3) .day-drag-handle'), 0, 200)

Thread.sleep(1000)

WebUI.dragAndDropByOffset(getElement('css', '.tp_day-container:nth-child(4) .day-drag-handle'), 0, 200)
