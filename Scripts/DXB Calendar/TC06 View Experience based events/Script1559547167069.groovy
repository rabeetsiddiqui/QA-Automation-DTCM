...
//Click  on Experience CTA
WebUI.click(getElement('css', '#events-top > div:nth-child(8) > div.search-filter-dsf > a:nth-child(3)'))
Thread.sleep(1000)

//Getting Color code after click on Experience CTA
String Fontcolor = WebUI.getCSSValue(getElement('css', '#events-top > div:nth-child(5) > div.search-filter-dsf > a.ng-binding.ng-scope.tab-btn.active'), 'background-color')
println (Fontcolor)
