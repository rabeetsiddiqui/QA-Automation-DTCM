...
public void datePickerTest() {
    def drivers = DriverFactory.getWebDriver()
        ...
        //Get Today's number
        String todayString = getCurrentDay(1);
		int today = Integer.parseInt(todayString)
		WebElement dateWidgetFrom;
		if(today > 28)
		{
			dateWidgetFrom = drivers.findElement(By.cssSelector("#datepicker-start > div > div:nth-child(2) .ui-datepicker-calendar > tbody"))
			//getNextMonth(1)
		}
		else{
...
//      drivers.findElement(By.cssSelector(".booking_dates > label:nth-child(1) .calendar_wrap"))             
        ...
        Thread.sleep(1700)
        dateWidgetFrom = drivers.findElement(By.cssSelector(".datepicker.calendar-page-datepicker .ui-datepicker.ui-widget.ui-widget-content.ui-helper-clearfix.ui-corner-all .ui-datepicker-calendar > tbody"))
		...
		if(today > 27)
		{
			...
			for (WebElement cell: columns) {
				println(cell)
				//Select Today's Date
				if (cell.getText().equals(today.toString())) {
					cell.click();
					break;
				}
			}
...
def drivers = DriverFactory.getWebDriver()
    ...
    String todayString = getCurrentDay(4);
	int today = Integer.parseInt(todayString)
	WebElement dateWidgetFrom;
    if(today > 27)
    {
