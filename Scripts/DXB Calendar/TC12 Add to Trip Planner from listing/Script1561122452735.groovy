...
{
	WebUI.click(getElement('css', '#event'+i+' > ul > li:nth-child(3) > a'))
}

String GetText = WebUI.getText(getElement('css', '.trip_count.tp_badge'))
int ConvertStringIntoInteger = Integer.parseInt(GetText);
println (ConvertStringIntoInteger)

if(tempCount==ConvertStringIntoInteger){
	println ("-----*****TEst passed****----")
}
