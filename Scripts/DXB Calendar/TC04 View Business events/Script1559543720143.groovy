...
Thread.sleep(1000)
//Getting Color code after click on Business CTA
String Fontcolor = WebUI.getCSSValue(getElement('css', '#events-top > div:nth-child(5) > div.search-filter-dsf > a.ng-binding.ng-scope.tab-btn.tab-margin.active'), 'background-color')
println (Fontcolor)
//Scroll to top
WebUI.scrollToElement(getElement('css', '#event-calendar-banner-carousel > div > div > div > div.bx-controls.bx-has-pager.bx-has-controls-direction.bx-has-controls-auto > div.bx-controls-auto'),10)
Thread.sleep(1000)
