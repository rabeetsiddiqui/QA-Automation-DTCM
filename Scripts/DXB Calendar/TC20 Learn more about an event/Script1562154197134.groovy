...
Thread.sleep(500)
WebElement hrefElement = driver.findElement(By.cssSelector("#events-top > div:nth-child(9) > div > div:nth-child(3) > ul > li:nth-child(1) > div > a"));
String hrefLink= hrefElement.getAttribute("href")
Thread.sleep(500)
